"""RollbackPlan (Phase 11). Generates a rollback template to revert to safer
modes. Does NOT manipulate keys or exchange state."""

from __future__ import annotations


def content() -> str:
    return """# Rollback Plan (TEMPLATE — human review required)
