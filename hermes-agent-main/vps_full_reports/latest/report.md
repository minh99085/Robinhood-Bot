...
_Generated: 2026-06-17T05:21:49.097141+00:00 · PAPER ONLY · inspection/reporting only_
...
| Field | Value |
|---|---|
| constraint_groups_scanned | 548.0 |
| raw_groups_discovered | 548.0 |
| incoherent_groups | 0.0 |
| candidate_arbitrages | 0.0 |
| certified_arbitrages | 0.0 |
| executable_depth_certified | 0.0 |
| rejected_fees_spread_depth_slippage | 15786 |
...
| fast_btc_price | 65722.005 |
| feed_disagreement_bps | None |
| market_stale_time_s | 127.535 |
...
| groups_scanned_positive | OK | constraint_groups_scanned=548.0 |
...
- Paper training running: yes · runtime: 133.04 min
...
- btc_fast_price_disagreement_bps: 0.406
...
- news_items_fetched: 3156
- news_items_used: 1144
...
- grok_calls_total: 5
- grok_calls_with_news: 5
- grok_proof_calls_total: 0
- grok_scheduler_calls_total: 5
- grok_total_calls_reconciled: True
- grok_scheduled_calls: 5
- grok_scheduler_eligible_targets: 827
- grok_scheduler_targets_selected: 5
- grok_scheduler_targets_skipped: 25
- grok_scheduler_skip_reasons: {'not_due_yet': 25}
- grok_advisory_only_count: 5
- grok_evidence_records_written: 5
- grok_advisory_max_calls_per_hour: 4
- grok_advisory_calls_per_hour: 2
- grok_market_groups_analyzed: 4
- grok_bregman_near_misses_analyzed: 4
- grok_bregman_incomplete_groups_analyzed: 3
- grok_bregman_malformed_groups_analyzed: 1
- grok_news_linked_markets_analyzed: 5
- grok_learning_features_written: 5
...
- constraint_groups_scanned: 744
- candidate_arbitrages: 0
- certified_arbitrages: 0
- best_projected_profit_per_set: 0.0
- max_bregman_distance: 0.0
- mean_cost_per_set: 1.017821
- expected_min_profit: 0.0
- near_miss_count: 10
- stage_rejections: {'adapter_failed': 1524, 'certifier_no_positive_profit': 744, 'realism_fees_spread_depth': 0, 'other': 0}
...
- bregman_near_misses_total: 817
- near_miss_one_fix_away_count: 135
- near_miss_depth_only_count: 135
- near_miss_not_exhaustive_count: 256
- near_miss_stale_refresh_failed_count: 0
- near_miss_by_rejection_reason: {'depth_too_thin': 142, 'invalid_simplex': 81, 'no_executable_price': 1, 'no_positive_edge': 303, 'not_exhaustive': 256, 'spread_too_wide': 1, 'stale_book': 33}
- near_miss_learning_priority_counts (high/med/low): {'high': 98, 'medium': 607, 'low': 112}
- near_miss_shadow_label_candidate_count: 98
- near_miss_learning_label_counts: {'needs_multiple_fixes': 379, 'no_positive_after_cost_edge': 303, 'would_certify_if_depth_sufficient': 135}
  - learn: binary:event:107726 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $6.7621 reaches required $25.0 (thin legs=1)
  - learn: binary:event:508139 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $5.512 reaches required $25.0 (thin legs=1)
  - learn: binary:event:304330 priority=high(1.0) label=would_certify_if_depth_sufficient shadow_candidate=True would_trade_if=worst-leg depth $22.6527 reaches required $25.0 (thin legs=1)
...
- malformed_group_count: 282885
- parsed_price_success_rate: 1.0
- bregman_depth_sufficient_groups: 135
- bregman_depth_insufficient_groups: 413
- bregman_high_liquidity_groups_scanned: 98
- bregman_all_groups_thin: False
- complete_set_count (certified): 0
- incomplete_set_count (not_exhaustive near-misses): 256
...
- bregman_groups_entered_certifier: 548
...
- bregman_real_market_zero_candidate_reason_counts: {'depth_too_thin': 114, 'invalid_simplex': 5, 'no_executable_price': 1, 'no_positive_edge': 126, 'not_exhaustive': 246, 'stale_book': 56}
- bregman_depth_sufficient_groups: 135
- bregman_depth_sufficient_but_negative_edge_count: 134
- bregman_best_depth_sufficient_group_lower_bound: 0.49
- bregman_best_depth_sufficient_group_reject_reason: not_exhaustive
- best_real_group: event:event:551781 depth_sufficient=True min_leg_depth=$1062.7627 (required $25.0) reject=not_exhaustive lower_bound=0.49 market_ids=['2419334', '2419369'] labels=['YES', 'YES']
  - sample: group=event:event:551781 reason=not_exhaustive depth_sufficient=True market_ids=['2419334', '2419369'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'YES']
  ...
  - sample: group=binary:event:584097 reason=stale_book depth_sufficient=False market_ids=['2506591'] token_ids=<REDACTED> '<REDACTED>'] labels=['YES', 'NO']
...
- malformed_group_count (reconciled): 282885
- bregman_malformed_group_reported_count (trainer certifier): 0
- bregman_malformed_group_runtime_count (ABCAS scanner): 536
- bregman_malformed_group_tail_count (diagnostics tail): 282885
- bregman_malformed_group_legacy_or_tail_only_count: 282349
- source: abcas_scanner_path_real_rejects

### 11d-stage. Trainer Certifier Per-Stage Census (read-only)

- bregman_rejection_stage_counts: {'edge': 126, 'realism': 171, 'validate_simplex': 251}
- bregman_max_divergence_gap (D(mu*||theta)): 11.10200309
- bregman_best_projected_lower_bound: 0.999
- bregman_positive_projected_but_rejected_count: 132
- bregman_positive_projected_rejected_by_stage: {'realism': 8, 'validate_simplex': 124}
- WHY certified=0: dominant stage=validate_simplex: groups are structurally INCOMPLETE (exhaustive=False / not a provable complete set) — buying a partial set is not a guaranteed hedge, so it is correctly NOT certified (completeness is never fabricated); NOTE: 132 group(s) had POSITIVE raw projected profit (best=0.999) but were still rejected (realism=8, validate_simplex=124) — the raw mispricing is real, but the set is not a certifiable complete hedge
- profit_lower_bound (min/mean/max): -14.912 / -0.031035 / 0.999
- groups by lower_bound sign (neg/zero/pos): 413 / 3 / 132
  ...
  - group: event:event:548813 exhaustive=False settlement_consistent=False profit_lower_bound=-1.05 divergence_gap=0.27703333 reason=not_exhaustive
  - group: binary:event:584097 exhaustive=True settlement_consistent=True profit_lower_bound=0.999 divergence_gap=0.4990005 reason=stale_book
  - group: binary:event:23784 exhaustive=True settlement_consistent=True profit_lower_bound=-0.001 divergence_gap=5e-07 reason=no_positive_edge
  - group: binary:event:598969 exhaustive=True settlement_consistent=True profit_lower_bound=0.999 divergence_gap=0.4990005 reason=no_executable_price
...
- bregman_shadow_labels_written: 140
- bregman_shadow_label_write_rate: 1.4286
- shadow_records_written: 11105
- shadow_labels_tail_nonempty: True
- shadow_label_write_rejection_reasons: {'already_written': 4553}
- profit_discovery_queue_items: 817
- profit_discovery_queue_by_priority: {'2': 135, '3': 180, '5': 502}
- profit_learning_status: shadow_data_only
- profit_data_sufficiency: building
- bandit_router_enabled: True
- bandit_action_counts: {'bregman_depth_watchlist': 3, 'bregman_not_exhaustive_completer': 3, 'bregman_rebalancing_watchlist': 3, 'grok_news_linked_near_miss': 11, 'active_learning_shadow': 35}
- bandit_action_rewards: {'bregman_depth_watchlist': 0.0, 'bregman_not_exhaustive_completer': 0.0, 'bregman_rebalancing_watchlist': 0.0, 'grok_news_linked_near_miss': 9.0, 'active_learning_shadow': 44.0}
...
- targeted_scan_bregman_groups_seen: 817
- targeted_scan_binary_groups_seen: 556
- targeted_scan_yes_no_pairs_seen: 480
- targeted_scan_binary_group_matches: 352 raw_market_matches=1694
- targeted_scan_bregman_categories: {'complete_yes_no_tight_spread': 438, 'high_liquidity_binary': 303}
- targeted_scan_raw_market_categories: {'complete_yes_no_tight_spread': 30, 'short_resolution': 1086, 'btc_eth_chainlink': 134, 'fed_macro_reference': 33, 'high_volume_news_linked': 1}
- targeted_scan_normalized_reject_reasons: {'depth_too_thin': 142, 'not_exhaustive': 256, 'stale_book': 33, 'no_positive_edge': 303, 'invalid_simplex': 81, 'no_executable_price': 1, 'spread_too_wide': 1}
...
- bregman_clob_hydration_eligible_groups: 548 selected=250 coverage_rate=0.4562
...
- zero_trade_blocker_if_any: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=12917; positive=0; best_after_cost_edge=-0.0025; best_reject={'group_id': 'binary:event:596172', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.0025, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 13.5, 'n_legs': 2}
...
- paper_relaxed_after_cost_positive_seen: 0 real_clob_book_seen=12917
- paper_relaxed_readiness_pnl_excluded: True
- paper_relaxed_pipeline_scanned: 28803
- paper_relaxed_real_book_candidates_seen: 12917 positive=0
- paper_relaxed_candidate_source_counts: {'binary_yes_no': 12917}
- paper_relaxed_candidates_blocked_by_reason: {'negative_after_cost_edge': 10803, 'depth_insufficient_for_1usd': 1560, 'stale_book': 554}
...
- bregman_incomplete_family_examples: [{'group_id': 'event:event:551781', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:548813', 'n_legs_scanned': 4, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:601566', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:36173', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:106811', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:597985', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:52166', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}, {'group_id': 'event:event:503159', 'n_legs_scanned': 2, 'declared_outcome_count': None, 'has_complete_marker': False, 'missing_outcome_count': None}]
- accelerated_discovery_enabled: True
- markets_scanned_per_tick: 1758 candidates_evaluated_per_tick=548 shadow_labels_per_tick=150 no_trade_labels_per_tick=548
- near_miss_records_written: 817 bregman_diagnostics_records_written=28803
- top_near_miss_edges_after_cost: [0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999, 0.999]
- top_bregman_rejection_reasons: [{'reason': 'not_exhaustive', 'count': 12359}, {'reason': 'no_positive_edge', 'count': 7077}, {'reason': 'depth_too_thin', 'count': 5666}, {'reason': 'stale_book', 'count': 3029}, {'reason': 'invalid_simplex', 'count': 596}, {'reason': 'no_executable_price', 'count': 62}, {'reason': 'spread_too_wide', 'count': 14}]
- report_buckets: {'realistic_executable_trades': 0, 'bregman_certified_bundles': 0, 'directional_exploit_trades': 0, 'shadow_exploration': 0, 'no_trade_labels': 548, 'near_miss_rejects': 817, 'paper_relaxed_exploration_trades': 0}
...
- market_quality_tier_counts: {'gold': 0, 'silver': 0, 'bronze': 796, 'watch': 718, 'reject_or_diagnostic': 244}
- market_quality_score_distribution: {'0.8+': 0, '0.6-0.8': 0, '0.4-0.6': 817, '0.2-0.4': 884, '<0.2': 57}
- targeted_scan_budget_by_category: {'complete_yes_no_tight_spread': 23, 'short_resolution': 893, 'btc_eth_chainlink': 116, 'fed_macro_reference': 33, 'broad_exploration': 564}
- targeted_scan_markets_by_category: {'complete_yes_no_tight_spread': 30, 'short_resolution': 1086, 'btc_eth_chainlink': 134, 'fed_macro_reference': 33, 'high_volume_news_linked': 1, 'broad_exploration': 615}
- high_liquidity_binary_markets_scanned: 303
- complete_yes_no_tight_spread_markets_scanned: 468
...
- bregman_blocker: no_certified_bregman_opportunity: dominant_reject=not_exhaustive(12359)
- relaxed_bregman_blocker: real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=12917; positive=0; best_after_cost_edge=-0.0025; best_reject={'group_id': 'binary:event:596172', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.0025, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 13.5, 'n_legs': 2}
...
- paper_trade_acceleration_blocker_if_any: no_paper_trade_opened_in_any_lane: bregman=no_certified_bregman_opportunity: dominant_reject=not_exhaustive(12359); relaxed_bregman=real_book_candidates_but_no_positive_after_cost_edge: real_book_candidates_seen=12917; positive=0; best_after_cost_edge=-0.0025; best_reject={'group_id': 'binary:event:596172', 'group_type': 'binary_yes_no', 'after_cost_edge': -0.0025, 'reject_reason': 'negative_after_cost_edge', 'depth_for_1usd': 13.5, 'n_legs': 2}; tiny_directional=no_active_learning_tiny_selection: exploration_enabled=True; active_learning_enabled=True; btc_pulse=btc_pulse_disabled
...
- Legacy random exploration blocked: 249
- Exploration counted toward readiness: no (should be false)
- Exploration consumes Bregman reserved capacity: no (should be false)
- active_learning_candidates_considered: 6540
- active_learning_candidates_selected: 6540
- exploration_trades_opened: 0
- exploration_shadow_only: 578
- exploration_rejected_by_realism: 123
...
- exploration_pnl: 0
- avg_active_learning_score_selected: 0.300326
- avg_execution_quality_selected: 0.192028
...
- metrics: present (not copied) (63045972 bytes)
- reports: copied (13127 bytes)
- training: present (not copied) (8111418029 bytes)
- micro_live_artifacts: copied (3218832 bytes)
